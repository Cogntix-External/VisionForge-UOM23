...
const App: React.FC = () => {
  ...
  const [sidebarMode, setSidebarMode] = useState<'expanded' | 'collapsed'>('collapsed');
...
const NotificationCard: React.FC<{ title: string; message: string; time: string; isNew: boolean }> = ({ title, message, time, isNew }) => (
