...
const MOCK_TASKS: KanbanTask[] = [
  { id: '1', crId: 'CR-001', title: 'Implement JWT Auth', column: KanbanColumn.IN_PROGRESS, priority: 'High' },
  { id: '2', crId: 'CR-001', title: 'Database Schema Update', column: KanbanColumn.DONE, priority: 'Medium' },
  { id: '3', crId: 'CR-002', title: 'Review API Documentation', column: KanbanColumn.BACKLOG, priority: 'Low' },
  { id: '4', crId: 'CR-003', title: 'Frontend Dashboard UI', column: KanbanColumn.REVIEW, priority: 'High' },
];
