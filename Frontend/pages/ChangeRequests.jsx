...
const MOCK_CRS = [
  { id: 'CR-2025-001', projectId: '1', projectName: 'SmartCore', title: 'Add dark mode', description: 'Enable theme switching', status: 'Approved', budget: 1500, timeline: '2 weeks', createdAt: 'Feb 15, 2025' },
  { id: 'CR-2025-002', projectId: '2', projectName: 'AppNest', title: 'Stripe Integration', description: 'Support multi-currency payments', status: 'Proposed', budget: 3000, timeline: '4 weeks', createdAt: 'Mar 01, 2025' },
  { id: 'CR-2025-003', projectId: '1', projectName: 'SmartCore', title: 'Social Auth', description: 'Add Google login', status: 'Pending', createdAt: 'Mar 05, 2025' },
];
              ...
              <tr key={cr.id} className="hover:bg-gray-50/50 transition-colors">
                ...
                <td className="px-10 py-10 whitespace-nowrap">
                   <span className={`px-6 py-2 rounded-full text-base font-bold ${
                    ...
                    cr.status === 'Proposed' ? 'bg-blue-100 text-blue-700' :
                    cr.status === 'Pending' ? 'bg-amber-100 text-amber-700' : 'bg-gray-100 text-gray-600'
                  }`}>
                    {cr.status}
                  </span>
                </td>
