...
const pageMeta = {
  ...
  "/company/KanbanBoardPage": {
    title: "Kanban Board",
    subtitle: "Track project tasks across workflow stages.",
  },
  "/company/Prd-details&Editor": {
    title: "PRD Details and Editors",
    subtitle: "Review and edit PRD content and ownership.",
  },
  "/company/Audit-trail": {
    title: "Audit Trail",
    subtitle: "Review change requests and approval activity.",
  },
  "/company/Version-history": {
    title: "Version History",
    subtitle: "Compare document versions and revision notes.",
  },
