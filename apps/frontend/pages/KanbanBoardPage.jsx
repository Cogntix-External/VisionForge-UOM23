...
const KanbanBoardPage = () => {
  ...
  const resolvedProject = useMemo(() => {
    ...
    if (remoteProject) {
      return {
        pid,
        name: remoteProject.name || "Kanban Board",
  ...
  const buildColumnsFromResponse = (response) => {
    ...
    response?.tasksByStatus?.forEach((statusGroup) => {
      ...
      column.cards = statusGroup.tasks.map((task) => ({
        id: task.id,
        title: task.title,
        ...
        attachmentsData: task.attachments || [],
                  ...
                  >
                    {column.cards.map((card) => (
                      <div
                        ...
                        onClick={() => {
                          closeAllMenus();
                          if (isCompletedCard(card, column.id)) {
